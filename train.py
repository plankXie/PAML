...
def get_args_parser():
    ...
    parser.add_argument('--checkpoint_latest', action='store_true',default=True)
    parser.add_argument('--checkpoint_best', action='store_true',default=True)
    ...
    # configure file
    parser.add_argument('--config',default='configs/PAML_R50_unc.py', type=str, help='Path to the configure file.')
...
def main(args):
    ...
    batch_sampler_train = torch.utils.data.BatchSampler(
        sampler_train, 12, drop_last=True)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('PAML training script', parents=[get_args_parser()])
